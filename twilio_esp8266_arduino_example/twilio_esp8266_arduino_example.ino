...
const char* ssid = "Michele's iPhone";
const char* password = "b7xzncv3wibad";
...
const char* account_sid = "ACf1fac71b61ce2ecc7f651b9e7d0f7116";
const char* auth_token = "ea984cc8c5c51f7493c8171e2dd05422";

// Details for the SMS we'll send with Twilio.  Should be a number you own 
// (check the console, link above).
String to_number    = "+16266441183";
String from_number = "+12053950706";
String message_body    = "Alert: Your loved one is in danger!";

// The 'authorized number' to text the ESP8266 for our example
String master_number    = "+16266441183";
